      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextFormField(
              // (value) {context.read<CheckoutBloc>().add(UpdateCheckout(email: value));}, context, 'Zip Code :'
                emaiController ,context, 'Email :'),
            _buildTextFormField(
              // (value) {context.read<CheckoutBloc>().add(UpdateCheckout(name: value));}, context, 'Zip Code :'
                nameController, context, 'Name :'),
            Text('DELIVERY INFORMATION', style: txtfont16),
            _buildTextFormField(
                    // (value) {context.read<CheckoutBloc>().add(UpdateCheckout(address: value));}, context, 'Zip Code :'
